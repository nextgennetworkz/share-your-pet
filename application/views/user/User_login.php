        ...
        <div id="ninja-slider">
            <div class="slider-inner">
                <ul>
                    ...
                    <li>
                        <a class="ns-img img-responsive" href="/share-your-pet/assets/images/0fbf8c7d5c732fdd9a36497a1562f903.jpg"></a>
                    </li>
                </ul>
        ...
        <div class="login-main">
            ...
            <div class="login-form">
                ...
                <form action="login" method="post">
                    <div class="input-wrp">
                        <i class="fa fa-envelope"></i><input type="email" placeholder="Enter Your E-mail" name="email" required>
                    </div>
                    <div class="input-wrp">
                        <i class="fa fa-lock"></i><input type="password" placeholder="Enter Your Password" name="password" required>
                    </div>
